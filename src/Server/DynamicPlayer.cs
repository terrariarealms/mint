...
public class DynamicPlayer : Player
{
    ...
    public override Terraria.RemoteClient RemoteClient =>
        throw new InvalidOperationException("Cannot get RemoteClient of DynamicPlayer.");
    ...
    public override void SendPacket(int packetId, NetworkText? text, int num1 = 0, float num2 = 0f, float num3 = 0f,
